...
struct MultiBirthdayProvider: IntentTimelineProvider {
    func getTimeline(for intent: MultiBirthdayWidgetIntent, in _: Context, completion: @escaping (Timeline<DateTimelineEntry>) -> Void) {
    ...
    private func getBirthdayDetails(for intent: MultiBirthdayWidgetIntent? = nil) -> [DateTimelineEntry] {
    ...
    func getSnapshot(for _: MultiBirthdayWidgetIntent, in _: Context, completion: @escaping (DateTimelineEntry) -> Void) {

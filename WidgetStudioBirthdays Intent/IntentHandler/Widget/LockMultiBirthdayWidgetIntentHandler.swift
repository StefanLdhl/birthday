//
//  LockMultiBirthdayWidgetIntentHandler.swift
...
class LockMultiBirthdayWidgetIntentHandler: NSObject, LockMultiBirthdayWidgetIntentHandling {
    func provideGroupsOptionsCollection(for _: LockMultiBirthdayWidgetIntent, with completion: @escaping (INObjectCollection<BirthdayGroup>?, Error?) -> Void) {

...
public final class ConfettiView: UIView {
    ...
    */
    ...
    public enum Content {
        ...
        case text(String, Double = 16.0, UIColor?)
    }
...
fileprivate extension ConfettiView.Content {
    ...
    var image: UIImage {
        ...
        case let .image(image, _):
            return image
        case let .text(string, size, color):
            let defaultAttributes: [NSAttributedString.Key: Any] = [
                
                .font: UIFont(name: "Helvetica-Bold", size: CGFloat(size)) ?? UIFont.boldSystemFont(ofSize: CGFloat(size)),
